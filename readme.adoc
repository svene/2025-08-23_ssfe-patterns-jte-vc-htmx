...
[source,html]
----
include::src/main/java/org/svenehrke/demo/web/pages/InjectionPageComponent.jte[]
----

[source,java]
----
include::src/main/java/org/svenehrke/demo/web/components/parentchild/ParentComponent.java[]
----

[source,html]
.InjectionPageComponent.jte
----
@import org.svenehrke.demo.web.p03pages.InjectionPageComponent
...
@import org.svenehrke.demo.web.p03pages.InjectionPageComponent
@import org.svenehrke.demo.web.p03pages.InclusionPageComponent
...
----
@import org.svenehrke.demo.web.p03pages.ParentPageComponent
